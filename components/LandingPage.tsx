...
const LandingPage: React.FC = () => {
    ...
    // Find the restaurant that has Landing Page enabled to use its settings
    const landingRestaurant = restaurants.find(r => r.homeViewMode === 'Landing Page') || restaurants[0];
    const settings = landingRestaurant?.theme;
