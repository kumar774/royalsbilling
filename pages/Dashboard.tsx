...
interface DashboardProps {
  view: 'overview' | 'menu' | 'settings' | 'pos' | 'orders' | 'expenses' | 'reports' | 'restaurants' | 'restaurants-new' | 'restaurants-edit' | 'customers';
}
    ...
    <div className="min-h-screen bg-gray-100 flex font-sans">
      ...
      <aside className="w-64 bg-white shadow-xl shadow-gray-200/50 flex-shrink-0 hidden md:flex flex-col z-10 print:hidden">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <NavItem to={`/dashboard/${restaurantId}/customers`} icon={FileText} label="Customers CRM" active={view === 'customers'} />
